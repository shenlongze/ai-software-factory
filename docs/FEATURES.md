...
>
> 版本: **v1.1.47** · 更新: 2026-08-24 · 依据: 实测命令 + 代码核对 + CHANGELOG
...
- **功能明细**:
  ...
  | 偏离提醒 | 会话启动提示主线未完成 | v1.1.38 |
  | 自动同步 | 代码证据→主线完成推断 + 会话启动自动 sync | v1.1.39 |
...
| v1.1.47 | CLI 方向键历史/行编辑 + 发现阶段确认短语修复 + PRD 写错项目修复 | CLI/修复 |
