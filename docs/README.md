# AI Software Factory — 文档导航（2026-08-24 更新）

> 给新人/协作 agent 的入口索引：先看什么、去哪看。历史/被取代文档见 [docs/archive/](./archive/README.md)。

## 5 分钟路径（必读，按顺序）

1. **完整产品方案书**（仓库根 `AI Software Factory — 完整产品方案书.md`）— **主文档**：22 章蓝图
   （定位/架构/能力/治理/学习/工具/行业/交互/路线/术语/竞品/自我进化/合规/安全/企业级/SDK化与商业化）+ **§1.4 当前实现状态对照**（✅/🚧/📐 锚定代码）
...
| **总体计划** | [总体计划-2026-08-25.md](../总体计划-2026-08-25.md) | 全局一盘棋: 状态/完成/待办/深化/路线 |
| **能力缺口** | [能力缺口-遗留问题清单.md](../能力缺口-遗留问题清单.md) | B-1~B-8 遗留问题统一查看 (防遗忘) |
