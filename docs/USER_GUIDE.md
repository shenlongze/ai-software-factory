...
> 版本: 1.1.2 | 适用: macOS / Linux | 读完本教程即可安装、使用、排查问题
...
#    从发布渠道下载 ai_software_factory-1.1.2-py3-none-any.whl

# 2. 建独立环境 (推荐, 不污染系统 Python)
python3 -m venv factory-venv
factory-venv/bin/pip install ai_software_factory-1.1.2-py3-none-any.whl

# 3. 验证安装
factory-venv/bin/factory --version
# → AI Factory v1.1.2   (看到这个就装好了)
```
