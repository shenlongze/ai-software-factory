...
> 生成时间: 2026-09-13T19:35:07+00:00 | 生成器: `scripts/legacy_inventory.py`
...
|---|---:|---:|---:|---:|---:|---|---|---|
| `factory-console` | 311 | 128350 | 0 | 0 | 0 | 混合：新 OS 内核 + 旧会话链 + Web + API | 拆分 → services / core / api / apps | 待绞杀 |
| `factory-core` | 135 | 33478 | 0 | 0 | 0 | L4 旧数据层，24 包互引 | 逐包复核后归档 | 已判 132/138 可归档（实测待复核） |
...
| `repo_paths.py` | 1 | 27 | 0 | 0 | 0 | — | — | — |
| **合计** | **529** | **197514** | **329** | **117** | **83** | | | |
...
入口：`bin/factory`, `src/legacy/factory-console/cli_factory.py`, `src/legacy/factory-console/web/backend/fastapi_adapter.py`

| 类别 | 文件 | 行数 | 含义 |
|---|---:|---:|---|
| 可达 | 329 | 150515 | 生产入口能走到（主链） |
| 仅测试可达 | 117 | 34937 | 只有测试能走到 |
