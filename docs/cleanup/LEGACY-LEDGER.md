...
> 生成时间: 2026-09-13T20:19:17+00:00 | 生成器: `scripts/legacy_inventory.py`
...
|---|---:|---:|---:|---:|---:|---|---|---|
| `factory-console` | 311 | 128356 | 0 | 0 | 0 | 混合：新 OS 内核 + 旧会话链 + Web + API | 拆分 → services / core / api / apps | 待绞杀 |
