...
TOOL_DEFS: list[dict[str, Any]] = [
    ...
    {"id": "code_search", "name": "代码检索", "stage": "开发", "status": "implemented",
     ...
     "cli": None, "api": None, "intent": None, "fn": "analysis_tools.search_code"},
    {"id": "quality_score", "name": "质量评分", "stage": "开发", "status": "implemented",
     "desc": "执行质量分+多候选优选", "keywords": ["质量分", "评分", "优选"],
     "cli": "factory eval", "api": "/api/board/quality", "intent": "project_quality", "fn": "execution_quality"},
    ...
    {"id": "coverage", "name": "覆盖率统计", "stage": "测试", "status": "implemented",
     ...
     "cli": "factory eval", "api": "/api/board/quality", "intent": None, "fn": "coverage_report"},
    {"id": "quality_gate", "name": "质量门/评测", "stage": "测试", "status": "implemented",
     "desc": "7 维评测 + 发布门", "keywords": ["评测", "质量门", "gate"],
     "cli": "factory eval --gate", "api": None, "intent": None, "fn": "eval_suite"},
    ...
    {"id": "monitor", "name": "监控采集", "stage": "运维", "status": "implemented",
     ...
     "cli": "factory status", "api": "/api/monitor", "intent": "monitor", "fn": "monitor.collect_system"},
    ...
    {"id": "backup", "name": "备份/恢复", "stage": "运维", "status": "implemented",
     ...
     "cli": "factory backup", "api": None, "intent": None, "fn": "backup.create_backup"},
