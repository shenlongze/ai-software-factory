  ...
  return (
    <div className="af-shell af-project-shell" data-testid="af-project-entry">
      ...
      <div className="af-shell-body">
        <AfProjectSidebar projectId={projectId} activePage={route.page} />
...
/** Project Header: ← 返回工作台 + 项目名 + lifecycle 徽标 (+ 进入 Human Console)。 */
export function AfProjectHeader({ project, pageLabel }: AfProjectHeaderProps): JSX.Element {
  return (
