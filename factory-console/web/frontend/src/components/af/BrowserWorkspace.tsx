    ...
    <div className="bw-home bw-home--company" data-testid="bw-home">
      ...
      <div className="bw-card" data-testid="bw-approvals">
        ...
        {approvalTab === 'pending' ? (
          ...
          <ul className="bw-approval-list bw-approval-list--history">
      ...
      <div className="bw-company-card" data-testid="bw-company-card">
        <button
          type="button"
          className="bw-company-card-head"
          onClick={() => setCollapsed((c) => !c)}
          aria-expanded={!collapsed}
        >
          <span>📁 项目</span>
          <span className="bw-company-toggle">{collapsed ? '▸' : '▾'}</span>
        </button>
      {!collapsed && (loading ? <p className="bw-muted bw-card-pad">加载中…</p> : projects.length === 0 ? (
