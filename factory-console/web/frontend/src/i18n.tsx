...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'nav.workspace.conversation': '对话',
    'nav.workspace.work': '工作',
    'nav.workspace.tower': '控制塔',
    ...
    // 公司首页
    'company.title': '我的公司',
    'company.focused': '⭐ 关注项目',
    'company.focusedEmpty': '（暂无收藏项目 — 点左栏项目 ⭐ 收藏后自动出现）',
    'company.todo': '📋 我的待办',
    ...
    'settings.background.opacity': '透明化',
    ...
    'chat.pin': '常驻',
    'chat.unpin': '取消常驻',
    'chat.talkHint': '和公司说话, 开始你的工作',
    'chat.guideTitle': '你今天想做什么？',
    'chat.guideSub': '直接告诉我你的目标 — 我会组织公司执行并汇报真实结果。',
    'chat.inputPlaceholder': '和公司说话… (讨论需求 / 开始工作 / 查询状态)',
  ...
  en: {
    ...
    'nav.workspace.conversation': 'Conversation',
    'nav.workspace.work': 'Work',
    'nav.workspace.tower': 'Control Tower',
    ...
    'company.focused': '⭐ Focused Projects',
    'company.focusedEmpty': '（No starred projects — star one from the sidebar to see it here）',
    ...
    'chat.pin': 'Pin',
    'chat.unpin': 'Unpin',
    'chat.talkHint': 'Talk to the company, start your work',
    'chat.guideTitle': 'What do you want to do today?',
    'chat.guideSub': 'Tell me your goal — I will organize the company to execute and report real results.',
    'chat.inputPlaceholder': 'Talk to the company… (discuss / start / check status)',
