...
PLAN: dict[str, dict[str, list[tuple[str, str]]]] = {
    ...
    "W 主流层风险防护": {
        "命脉级风险 (Founder 2026-08-26 盲点扫描: 影响主流程的地基)": [
            ("W-1", "数据资产保护: git 定期推送 + ~/.factory 备份/导出/迁移 (D-1)", "P0"),
            ("W-2", "LLM provider 故障切换 (D-7): 多 provider 自动降级/告警", "P0"),
            ("W-3", "服务守护/自启: 开机自动恢复 + 进程守护 + 心跳", "P0"),
            ("W-4", "API 认证: 本地 token / 登录 / 权限边界", "P1"),
            ("W-5", "数据结构版本化迁移 (D-3): schema 版本 + 迁移脚本", "P1"),
            ("W-6", "核心执行链 CI 稳定验证: mock/可复现真 LLM 测试", "P1"),
            ("W-7", "操作撤销/确认: 删除/推送二次确认 + 回收站", "P1"),
            ("W-8", "监控自举告警: Monitor 自身健康上报/心跳", "P2"),
        ],
    },
    "V 工具缺口补齐": {
