...
ALIAS_PREFIXES: dict[str, str] = {
    ...
    "orchestration": "ai_factory_os.services.execution.orchestration",
    "product": "ai_factory_os.services.work.product",
    "providers": "ai_factory_os.infrastructure.llm.providers",
    "recovery": "ai_factory_os.services.execution.recovery",
    "validation": "ai_factory_os.services.validation",
    "workflows": "ai_factory_os.services.work.workflows",
