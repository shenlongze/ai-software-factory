"""src/ai_factory_os/plugins/agents/developer.py — Developer Agent MVP (第一个 AI Employee)。
...
from ai_factory_os.contracts.llm.provider import ProviderError, ProviderInterface, ProviderRequest
