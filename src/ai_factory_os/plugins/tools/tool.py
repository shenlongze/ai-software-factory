"""src/ai_factory_os/plugins/tools/tool.py — S10-018 Task 001 Tool Runtime Foundation。
...
class ToolRegistry:
    ...
    def with_system_tools(cls) -> "ToolRegistry":
        ...
        registry = cls()
        from ai_factory_os.plugins.tools.filesystem import build_filesystem_read_tool
