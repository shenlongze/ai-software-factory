"""src/ai_factory_os/services/execution/external/host_assets.py — 宿主资产发现与导入 (M2)。
...
_ROLE_KEYWORDS: list[tuple[str, str]] = [
    ...
    ("test", "tester"), ("qa", "tester"),  # testing-* 优先于通用 examiner
    ("review", "reviewer"), ("examiner", "reviewer"), ("audit", "reviewer"),
    ("product", "product"), ("strategy", "product"), ("strategist", "product"),
    ("professor", "product"), ("viability", "product"), ("complaint", "product"), ("ten-x", "product"),
    ("research", "researcher"), ("analyst", "researcher"), ("cartographer", "researcher"),
