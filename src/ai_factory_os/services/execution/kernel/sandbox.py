"""src/ai_factory_os/services/execution/kernel/sandbox.py — Sandbox MVP (临时目录项目副本 + git 追踪 + patch 导出)。
...
from ai_factory_os.services.execution.types import SandboxSession, new_id
