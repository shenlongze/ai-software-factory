...
from ai_factory_os.services.execution.external import registry as _ext_registry  # noqa: E402  ★ 过渡: 整包未迁, 用绝对路径
...
def build_executor_factory(
    ...
    *,
    ...
    """
    from ai_factory_os.services.execution.external.executor import run as ext_run  # ★ 过渡: 整包未迁
