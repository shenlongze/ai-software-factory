"""src/ai_factory_os/services/governance/audit/audit_event.py — AuditEvent 统一审计事件模型 (S10-069)。
...
EVENT_TYPES: tuple[str, ...] = (
    ...
    "PRODUCTION_RUN_RECOVERY_FAILED",
    # S9: Agent Kernel 事件
    "AGENT_RUN_CREATED",
    "AGENT_RUN_STARTED",
    "AGENT_RUN_COMPLETED",
    ...
    "RELEASE_BLOCKED",
    "RELEASE_FAILED",
    # S20: Release/Rollback Verification 事件
    ...
    "HEALTH_DEGRADED",
    "HEALTH_FAILED",
    "HEALTH_INCIDENT_CREATED",
    "HEALTH_INCIDENT_RESOLVED",
    "HEALTH_RECOVERY_STARTED",
    "HEALTH_RECOVERY_COMPLETED",
    "HEALTH_RECOVERY_FAILED",
    # S23: Intelligence 事件
    "INTELLIGENCE_ANALYSIS_STARTED",
    "INTELLIGENCE_ANALYSIS_COMPLETED",
    "INTELLIGENCE_ANALYSIS_FAILED",
    "INTELLIGENCE_RECOMMENDATION_DECIDED",
    # S25: Adaptive Workforce 事件
    "WORKFORCE_VARIANT_PROPOSED",
    "WORKFORCE_VARIANT_ACTIVATED",
    "WORKFORCE_ASSIGNMENT_CREATED",
    # S26: LLM Experiment 事件
    ...
    # S40: Optimization 事件
    "OPTIMIZATION_OPPORTUNITY_CREATED",
    ...
    "OPTIMIZATION_GOVERNED",
    "OPTIMIZATION_CANARY_STARTED",
    "OPTIMIZATION_CANARY_FAILED",
    "OPTIMIZATION_PROMOTED",
