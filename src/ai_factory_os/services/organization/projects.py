"""src/ai_factory_os/services/organization/projects.py — 统一生命周期模型 (Sprint 7 S7-001)。
...
class ArtifactType(str, Enum):
    ...
    REVIEW_REPORT = "review_report"   # ★ 代码评审产物（2026-09-14 补 ✓）
    SECURITY_REPORT = "security_report"  # ★ 安全/合规审查产物（2026-09-14 补 ✓）
    USER_DOC = "user_doc"                  # ★ 用户交付文档（2026-09-14 补 ✓）   # S7-004: 结构化缺陷报告
    RELEASE = "release"
...
class Project(_OrgModel):
    ...
    archived: bool = False               # Founder 2026-08-26: 归档 (软归档, 可恢复; 独立于生命周期)
